...
💬 Anonymous Student Chats

</h2>

<p class="mb-0">

Monitor anonymous student conversations and student wellbeing.

</p>

</div>

<a href="counsellor_dashboard.php" class="btn btn-light btn-dashboard">
...
<a href="counsellor_chat_view.php?chat_id=<?= (int)$row['id']; ?>"
