...
// Standard security session gate check
...
// Dynamic Back Button Resolver for Viva presentation polish
$back_url = "student_profile.php"; // Default fallback
if ($user_role === "admin") {
    $back_url = "admin_dashboard.php";
} elseif ($user_role === "teacher") {
    $back_url = "teacher_dashboard.php";
} elseif ($user_role === "counsellor") {
    $back_url = "counsellor_dashboard.php";
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Strong password complexity validation matrix
    ...
    elseif (!preg_match("/[\W_]/", $new_password)) {
        ...
        // Secure identification extraction via bound prepared structures
...
<div class="container py-4">
  ...
  <!-- Dynamic Back Target URL to support multi-role usability -->
  <a href="<?= htmlspecialchars($back_url) ?>" class="btn btn-outline-dark soft-btn mb-3">← Back</a>
