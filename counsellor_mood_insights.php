...
<head>
  ...
  <style>
    ...
    .cardx{ border:0; border-radius:20px; background: rgba(255,255,255,0.90); box-shadow:0 12px 25px rgba(0,0,0,0.10); padding:18px; }
  </style>
</head>
<body>
<div class="container py-4" style="max-width:1100px;">
  ...
  <div class="hero mb-4">
    ...
    <div class="small">Counsellor overview of student mood logs (summary only)</div>
  </div>
  ...
  <?php else: ?>
    <div class="row g-3">
      ...
      <div class="col-md-4"><div class="cardx"><div class="fw-bold">Other</div><div class="small text-muted">Other moods may exist in DB but are not shown here.</div></div></div>
    </div>
  <?php endif; ?>
</div>
</body>
